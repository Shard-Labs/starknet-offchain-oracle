...
import { ORACLE_CONTRACT_ADDRESS, LOCALHOST_URL } from "./constants.js";

const provider = new Provider({baseUrl: LOCALHOST_URL,  feederGatewayUrl: 'feeder_gateway', gatewayUrl: 'gateway'});
...
async function processRequest(requestData) {
    ...
    const calldata = [
        ...
        response.team1Score.toString(),                 // Array Param Element #3 - Team 1 Score
        awayTeamBigInt.toString(),                      // Array Param Element #4 - Team 2
        response.team2Score.toString(),                 // Array Param Element #5 - Team 2 Score
    ...
    console.log(callbackTx.transaction_hash);
}
